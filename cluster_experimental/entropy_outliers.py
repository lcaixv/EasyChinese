...
with open('pairwise_prob_hsk.pkl', 'rb') as file:  # Correct file path
    similarity_matrix = pickle.load(file)

with open('hsk_list.pkl', 'rb') as file:  # Correct file path
...
print('Geometric Ranked Different-Cluster Outlier Score\n')
print(f'r = {r}')
