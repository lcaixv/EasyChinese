...
# Set number of clusters to 214 and perform GMM clustering
n_clusters = 214
gmm = GaussianMixture(n_components=n_clusters, n_init=10, random_state=0)
gmm.fit(embeddings)
...
# Print GMM clustering information
print(f"GMM, {n_clusters} Clusters\n")
